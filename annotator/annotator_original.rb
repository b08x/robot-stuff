...
def to_midi(audiofile)
  ...
  midifile_dir = File.join("/home/b08x/Library/Midi")
...
def get_tempo(audiofile)
  ...
  profile = File.join("/home/b08x/Workspace/robot-stuff/annotator/plugins/fixedtempo.n3")
  cmd = TTY::Command.new(printer: :pretty)
...
def get_notes(audiofile)
  notes = []
  cmd = TTY::Command.new(printer: :pretty)
  profile = File.join("/home/b08x/Workspace/robot-stuff/annotator/plugins/pynotes.n3")
...
file = File.join("/home/b08x/Library/Sounds/Sounds/samples/misc/000248ghostsofthingstcome.flac")
